const i18n = {
  en: {
    ...
    exp1: 'Ant Group, Department of Large Security · Algorithm Engineer Intern (Agent Safety)',
    exp2: 'Alibaba Future Living Lab · Algorithm Engineer Intern (Coding Agent Safety)',
    exp3: 'JD Explore Academy · Algorithm Engineer Intern',
  ...
  zh: {
    ...
    exp1: '蚂蚁集团大安全部 · 实习算法工程师（Agent 安全）',
    exp2: '阿里巴巴未来生活实验室 · 实习算法工程师（Coding Agent 安全）',
    exp3: '京东探索研究院 · 算法工程师实习生',
